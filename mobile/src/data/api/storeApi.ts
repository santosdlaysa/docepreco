...
type SettingsInput = Partial<Pick<StoreSettings, 'active' | 'storeName' | 'description' | 'acceptsDelivery' | 'acceptsPickup' | 'minOrderValue' | 'deliveryFee' | 'coverImageUrl' | 'paymentMethods' | 'pixKey' | 'pixKeyType' | 'pixReceiverName' | 'address' | 'city' | 'category' | 'useBusinessHours' | 'businessHours' | 'loyaltyEnabled' | 'loyaltyGoal' | 'loyaltyReward'>> & {
